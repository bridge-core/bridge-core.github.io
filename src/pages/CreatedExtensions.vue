<template>
	<Layout :showSidebars="false">
		<div class="mt-12 mx-12">
			<h1>Extensions</h1>
			<p>
				bridge. has a powerful extension API that has been used to
				create amazing extensions for the editor. You can find all
				officially available plugins here!
			</p>
			<h2>Submission</h2>
			<p>
				<span>
					You can submit your extensions to the official extension
					store
				</span>
				<g-link
				...
				>
				<span
					>. Accepted extensions appear inside of bridge.'s extension
